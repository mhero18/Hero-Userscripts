...
(function () {
    ...
    if (document.body.innerHTML.search("has been added to your inventory") != -1) {
        restockTimeElement.innerHTML = `<br>You restocked this item in ${totalRestockTime} seconds ${haggleTimeMessage}.`;
        sessionStorage.removeItem("refreshTime");
        sessionStorage.removeItem("haggleStartTime");
        sessionStorage.removeItem("haggleEndTime");
    } else if (document.body.innerHTML.search("is SOLD OUT!") != -1) {
        restockTimeElement.innerHTML = `<br>Your time was ${totalRestockTime} seconds${haggleTimeMessage}.`;
        sessionStorage.removeItem("refreshTime");
        sessionStorage.removeItem("haggleStartTime");
        sessionStorage.removeItem("haggleEndTime");
    }
    document.querySelector("#container__2020 p:last-of-type").appendChild(restockTimeElement);
})();
